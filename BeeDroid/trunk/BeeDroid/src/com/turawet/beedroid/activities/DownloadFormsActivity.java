...
public class DownloadFormsActivity extends ListActivity
{
	...
	private static class EfficientAdapter extends BaseAdapter
	{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			if (convertView == null)
			{
				convertView = mInflater.inflate(R.layout.downloads_forms, null);
				
				// Creates a ViewHolder and store references to the two children
				// views
				// we want to bind data to.
				holder = new RowHolder();
				holder.formName = (TextView) convertView.findViewById(R.id.form_name);
				holder.formVersion = (TextView) convertView.findViewById(R.id.form_version);
			...
			holder.formName.setText(DATA[position]);
			holder.formVersion.setText("1.0");
