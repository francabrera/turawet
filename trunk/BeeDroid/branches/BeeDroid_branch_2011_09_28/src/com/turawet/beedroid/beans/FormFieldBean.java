 ...
 * @param section_order
 *           : The order of the FormField within the section
 * @param field_group_order
 *           : The order of the FormField within the group
 * @param type
 *           : The type of the element "FormField"
 * @param required
 *           : Whether this field must be filled or not
 * @param fieldOptions
 *           : Options list
 * @param properties
 *           : Properties list
