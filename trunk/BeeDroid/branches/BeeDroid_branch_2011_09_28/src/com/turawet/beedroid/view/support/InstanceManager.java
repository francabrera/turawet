...
//import com.turawet.beedroid.field.view.FieldViewFactoryImpl;
...
//	private SectionBookmarksCollection	sectionBookmarks;
//	
//	/**
//	 * @param context
...
//	 */
//	public InstanceManager(Context context, Instance instance)
//	{
//		this.instance = instance;
//		this.context = context;
//		this.sectionBookmarks = new SectionBookmarksCollection();
//	}
//	
//	/**
//	 * @return
...
//	 */
//	public void renderAllFormFieldViewsForThisInstance() throws IllegalFieldTypeException
//	{
//		FieldViewFactory formFieldViewFactory = new FieldViewFactoryImpl(context);
//		List<GenericInstanceFieldBean> allFieldBeans = instance.getAllFieldBeans();
//		for (GenericInstanceFieldBean fieldBean : allFieldBeans)
//		{
//			// FormFieldView formFieldView =
//			// formFieldViewFactory.makeFormFieldView(fieldBean);
//			// formFieldsViews.add(formFieldView);
//		}
//	}
//	
//	/*
...
//	 */
//	// if (instance.isGeolocalized())
//	// {
//	// fields.add(formFieldViewFactory.makeFormFieldView(FieldType.GEO));
//	// sectionBookmarks.addNewBookmark("Geolocalizar", page);
//	// }
//	// return fields;
//	
//	/**
...
//		
//		String sectionTitle = instance.getSection(section).getName();
...
//		 */
//		GenericInstanceFieldBean fieldBean = (GenericInstanceFieldBean) instance.getSection(sectionInd).getSectionChildren().get(fieldInd);
//		
...
//		 */
//		GenericInstanceFieldBean instanceBean = (GenericInstanceFieldBean) instance.getSection(section).getSectionChildren().get(field);
//		/*
...
//	{
//		int numOfSections = instance.getNumberOfSections();
//		int i = 0;
//		for (int section = 0; section < numOfSections; section++)
//		{
//			int numOfFields = instance.getSection(section).getSectionChildren().size();
...
//	}
//	
//	public List<View> getAllFormFieldViews()
//	{
